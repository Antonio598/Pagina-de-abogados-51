...
export const legalDocs: LegalDoc[] = [
  {
    ...
    sections: [
      ...
      "Documentos que cargas en el portal del cliente: finalidad, acceso, conservación y eliminación",
      "Seguimiento automatizado por mensajería y transferencia a nuestro proveedor de automatización",
  ...
  },
  {
    ...
    sections: [
      ...
      "Alcance de la defensa laboral patronal y asuntos que no se atienden",
      "Condiciones del crédito de la asesoría sobre los honorarios de representación",
      "Condiciones y alcance delimitado de la revisión laboral prioritaria",
  ...
  },
  {
    ...
    sections: [
      ...
      "Cookie de sesión del portal del cliente",
